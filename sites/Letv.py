...
class Letv:
    ...
    def calc_time_key(self, time):
        """Calculate the special time
        :param time:
        :return:
        """
    ...
    def video_info(self, vid, **kwargs):
        """Give u want
        :param vid:
        :param kwargs:
        :return:urls
        """
        url = 'http://api.letv.com/mms/out/video/playJson?id={}&platid=1&splatid=101&format=1&tkey={}&domai' \
              'n=www.letv.com'.format(
            vid, self.calc_time_key(int(time.time())))
